...
# 8 out of the 13 ns lying along both diagonals are prime; 
...
# Counts the number of primes in the outer spiral
# of length side_len
def spiralPrimes(side_len):
	n = side_len * side_len
	n -= side_len - 1
	num_primes = 0
	for i in range(3):
...
num_total = 5
side_length = 5
while 10 * num_prime >= num_total:
	num_prime += spiralPrimes(side_length)
	num_total += 4
	side_length += 2
print(num_prime, num_total)
print(side_length - 2)